...
const Home = () => {
    ...
    const addCustom = () => {
        ...
        setCustomTask("")
        var txtfield = document.getElementById('txtarea')
        txtfield.value = txtfield.value.replace(/\n/g, "")
        txtfield.value = txtfield.value.replace(/ /g, "")
        txtfield.value = txtfield.value.replace(/&#32/g, "")
        txtfield.value = txtfield.value.replace(/&#160/g, "")
        txtfield.value = txtfield.value.replace(/&#8192/g, "")
        txtfield.value = txtfield.value.replace(/&#8194/g, "")
        txtfield.value = txtfield.value.replace(/&#8195/g, "")
        txtfield.value = txtfield.value.replace(/&#8196/g, "")
        txtfield.value = txtfield.value.replace(/&#8197/g, "")
        txtfield.value = txtfield.value.replace(/&#8198/g, "")
        txtfield.value = txtfield.value.replace(/&#8199/g, "")
        txtfield.value = txtfield.value.replace(/&#8193/g, "")
        txtfield.value = txtfield.value.replace(/&#8200/g, "")
        txtfield.value = txtfield.value.replace(/&#8201/g, "")
        txtfield.value = txtfield.value.replace(/&#8202/g, "")
        txtfield.value = txtfield.value.replace(/&#8232/g, "")
        txtfield.value = txtfield.value.replace(/&#8287/g, "")
        txtfield.value = txtfield.value.replace(/&#12288/g, "")
    }
